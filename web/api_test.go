...
func TestUnknownPair(t *testing.T) {
	...
	assert.Equal(t, response.Params.Price, float64(0), "price returned from API is 0")
	assert.Equal(t, response.Params.Volume, float64(0), "volume returned from API is 0")
